    ...
    <section class="top-bar-section">
        ...
        <ul class="right hidden-for-small-only">
            <?php foreach ($nav['social'] as $media => $url) { ?>
                <li>
                    <a href="<?= $url ?>" class="social-icon"><span class="fa fa-fw fa-lg <?= $nav['socialIcons'][$media] ?>"></span></a>
                </li>
            <?php } ?>
        </ul>
        ...
        <!-- Left Nav Section -->
        <ul class="left">
            <?php foreach ($nav['topNav'] as $pageid => $title) { ?>
                <li>
    ...
    <div class="row inline-list show-for-small-only">
        <?php foreach ($nav['social'] as $media => $url) { ?>
            <div class="small-3 columns">
                <a href="<?= $url ?>" class="social-icon"><span class="fa fa-fw fa-lg <?= $nav['socialIcons'][$media] ?>"></a>
            </div>
        <?php } ?>
    </div>
    <p>&copy;2016 Kate Kinsman</p>
</footer>
